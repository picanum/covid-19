...
datos %>% select(ccaa_iso, fecha, num_casos_prueba_pcr) %>%
  ...
  annotate("text", x = as.Date("2020-07-25"), y = 87, label = "Aragón", size = 6) +
  ...
  annotate("text", x = as.Date("2020-07-22"), y = 10.5, label = "Navarra", size = 4) +
  labs(x = "Fecha", y = "Porcentaje de casos",
       ...
       caption = "Actualizado a 14/08/2020 | @Picanumeros") +
...
datos %>% select(provincia_iso, fecha, num_casos_prueba_pcr) %>%
  ...
  annotate("text", x = as.Date("2020-06-27"), y = 18.5, label = "Málaga", size = 3) +
  annotate("text", x = as.Date("2020-07-25"), y = 7.5, label = "Zaragoza", size = 6) +
  annotate("text", x = as.Date("2020-08-05"), y = 97, label = "Almería", size = 3) +
  annotate("text", x = as.Date("2020-07-30"), y = 99, label = "Alicante", size = 3) +
  annotate("text", x = as.Date("2020-07-07"), y = 27.5, label = "Lugo", size = 3, angle = -15) +
  annotate("text", x = as.Date("2020-03-02"), y = 4.5, label = "Álava", size = 4) +
  annotate("text", x = as.Date("2020-07-27"), y = 19.5, label = "Valencia", size = 3)
